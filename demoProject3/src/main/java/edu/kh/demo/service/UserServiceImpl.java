...
@Service // - Service 역할(비즈니스 로직 처리)임 명시
		 // - Bean 등록 (== Spring이 관리하는 객체 == IOC)
public class UserServiceImpl implements UserService {

	@Autowired // - 등록된 Bean 중에서 
	...
	@Transactional // - 해당 메서드 수행 중 
				   // 	RuntimeException 발생 시 롤백 수행
				   // - 예외가 발생하지 않으면 메서드 종류 후 commit 수행
	@Override
	...
	// 사용자 삭제
	@Transactional // 예외 발생 시 rollback / 메서드 종료 시 commit
	@Override
