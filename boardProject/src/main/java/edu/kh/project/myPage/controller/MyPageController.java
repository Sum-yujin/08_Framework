...
// 1. Model을 이용하여 request -> session으로 scope 변경
// 2. @SessionAtteibute를 이용해
...
public class MyPageController {
	...
	public String updateInfo(
		...
		// - 사용 방법
		// 1) 클래스 위에 @SessionAttribute"s" 어노테이션을 작성하도
